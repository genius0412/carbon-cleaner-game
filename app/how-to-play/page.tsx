...
const gauges = [
  ...
  { name: "Budget", desc: "Starts at $2M (Mayor), plus $1M each in-game year. Every project draws from it." },
];
    ...
    <main className="relative flex min-h-screen flex-col eco-grid">
      ...
      <section className="z-10 mx-auto w-full max-w-4xl px-6 py-12">
        ...
        <p className="mt-4 max-w-2xl text-lg text-mist">
          Your mandate: reach net-zero carbon by 2100 without losing the public's
          trust.
        </p>
        ...
        <Card className="mt-4">
          <p className="text-sm text-fog/90">
            <strong className="text-leaf">Win</strong> by getting Carbon Gain/Month to ≤ 0.00 any time before December 2100 (with at least minimal governing support).
            <br />
            <strong className="text-danger">Lose</strong> if you reach January 2101 without net-zero, or if Current Carbon hits 600 ppm.
          </p>
        </Card>
