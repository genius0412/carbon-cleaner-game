      ...
      questions: [
        {
          ...
          options: [
            "Water vapor isn't actually a greenhouse gas",
            "CO₂ from fuel is what we keep adding; the warming it causes then puts more water vapor in the air",
            "There's barely any water vapor in the atmosphere",
            "Water vapor is released mainly by factories",
          ],
          answer: 1,
        ...
        },
        {
          ...
          options: [
            "Switching how we make electricity and get around off fossil fuels",
            "Getting everyone to recycle more cardboard",
            "Turning off lights when we leave a room",
            "Swapping plastic straws for paper ones",
          ],
          answer: 0,
        ...
        },
        {
          ...
          options: [
            "We stop emitting every greenhouse gas overnight",
            "We balance the emissions we still produce with an equal amount removed or avoided",
            "Global temperatures drop back to where they were in 1900",
            "Only heavy industry has to cut emissions",
          ],
          answer: 1,
